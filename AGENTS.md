...
| [.codex/documents/methods/ECS/ENTITY_FACTORY_RULES.md](.codex/documents/methods/ECS/ENTITY_FACTORY_RULES.md) | Shared entity factory rules for JECS mutation, archetype creation, queries, and destruction boundaries. |
| [.codex/documents/methods/ECS/ENTITY_RUNTIME_BOUNDARIES.md](.codex/documents/methods/ECS/ENTITY_RUNTIME_BOUNDARIES.md) | Shared runtime ownership rules for EntityContext, feature setup components, and cleanup-driven teardown. |
| [.codex/documents/methods/ECS/REQUEST_AND_OUTCOME_PIPELINE_RULES.md](.codex/documents/methods/ECS/REQUEST_AND_OUTCOME_PIPELINE_RULES.md) | Request-entity and outcome pipeline rules for actor state, transient work, and system-owned orchestration. |
...
| [.codex/documents/methods/ECS/WORLD_ISOLATION_RULES.md](.codex/documents/methods/ECS/WORLD_ISOLATION_RULES.md) | World isolation rules for shared EntityContext world ownership and Infrastructure-only JECS access. |
| [.codex/documents/methods/ECS/PHASE_AND_EXECUTION_RULES.md](.codex/documents/methods/ECS/PHASE_AND_EXECUTION_RULES.md) | Shared ECS phase and execution order, cleanup resolution, and deferred destruction boundaries. |
...
| [.codex/documents/architecture/backend/SHARED_ENTITY_ECS_ARCHITECTURE.md](.codex/documents/architecture/backend/SHARED_ENTITY_ECS_ARCHITECTURE.md) | Shared EntityContext ECS architecture, request-driven flow, and runtime ownership model. |
