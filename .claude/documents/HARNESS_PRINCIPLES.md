...
The harness is the set of files under `.claude/` that govern how Claude behaves in this project — agents, commands, behavioral rules, and documentation. These principles are the framework for evaluating and improving any part of it. Consult this document before adding a new agent, command, or rule, and when auditing an existing one.
