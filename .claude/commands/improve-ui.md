...
- `.claude/documents/architecture/frontend/FRONTEND.md`
- `.claude/documents/architecture/frontend/HOOKS.md`
- `.claude/documents/architecture/frontend/COMPONENTS.md`
- `.claude/documents/architecture/frontend/SCREEN_TEMPLATES.md`
- `.claude/documents/architecture/frontend/ANIMATION_PATTERN.md`
- `.claude/documents/architecture/frontend/ANTI_PATTERNS.md`
