...
- `.codex/documents/coding-style/READABILITY.md` (especially "Sub-Section Comments")
- `.codex/documents/coding-style/MOONWAVE.md` (to understand what NOT to do — no `--[=[...]=]` or `---`)
