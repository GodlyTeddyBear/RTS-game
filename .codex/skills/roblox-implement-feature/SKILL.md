...
- Preserve DDD/CQRS boundaries.
- Preserve Result/WrapContext rules.
- Preserve centralized errors and types.
- Preserve frontend layer boundaries and read/write hook separation.
- Preserve persistence lifecycle contracts when touched.
