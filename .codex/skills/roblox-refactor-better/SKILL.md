---
name: roblox-refactor-better
description: Use when the user asks Codex to analyze or refactor Roblox/Luau code for readability, abstraction quality, naming, control flow, library usage, or architecture-aligned cleanup using this repo's refactor-better workflow.
---
...
3. Read the relevant architecture and coding-style docs for the target area.
