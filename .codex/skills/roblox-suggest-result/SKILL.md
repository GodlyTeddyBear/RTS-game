---
name: roblox-suggest-result
description: Use when the user asks Codex to suggest or apply this repo's backend Result/error-handling pattern, success/data contracts, WrapContext boundaries, or related error-flow improvements.
---
...
1. Read `AGENTS.md`.
2. Read `.codex/documents/architecture/backend/ERROR_HANDLING.md`.
