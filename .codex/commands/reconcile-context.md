...
2. Read `.codex/documents/architecture/backend/DDD.md`, `CQRS.md`, `ERROR_HANDLING.md`, `STATE_SYNC.md`, and `SYSTEMS.md`.
3. Read `.codex/commands/review.md` and use its checklist as the baseline rule set.
