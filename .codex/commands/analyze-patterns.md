...
- `.codex/documents/architecture/backend/DDD.md` — layer rules, constructor injection, value objects
- `.codex/documents/architecture/backend/ERROR_HANDLING.md` — success/data pattern, logging format
- `.codex/documents/architecture/backend/STATE_SYNC.md` — atom mutation rules, deep clone requirement
- `.codex/documents/patterns/PROGRAMMING_PATTERNS.md` — GoF patterns with project-specific applicability tiers
