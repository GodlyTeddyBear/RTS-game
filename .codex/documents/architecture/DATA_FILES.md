...
- Split a data file into a folder module when it contains **more than one logical category** of entries.
- Split a data file into a folder module when a single category has grown large enough that scrolling past it obscures the rest of the file.
