...
local EVENT_SOUND_MAP = {
	-- Worker
	[Events.Worker.WorkerHired]       = "WorkerHired",
	[Events.Worker.WorkerLeveledUp]   = "LevelUp",
	[Events.Worker.MiningCompleted]   = "MiningComplete",
	[Events.Worker.WorkerRoleAssigned] = "WorkerHired",
	-- Shop / Inventory
	[Events.Inventory.ItemPurchased]  = "Purchase",
	[Events.Inventory.ItemSold]       = "Sell",
	[Events.Inventory.PurchaseFailed] = "PurchaseFailed",
	[Events.Inventory.ItemAdded]      = "ItemPickup",
	-- Forge
	[Events.Crafting.CraftingStarted]   = "CraftStart",
	[Events.Crafting.CraftingCompleted] = "CraftComplete",
	-- Commission
	[Events.Commission.CommissionAccepted]    = "CommissionAccepted",
	[Events.Commission.CommissionDelivered]   = "CommissionDelivered",
	[Events.Commission.CommissionTierUnlocked] = "TierUnlocked",
	-- Guild
	[Events.Equipment.EquipmentChanged] = "Equip",
}
