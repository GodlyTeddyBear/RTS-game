...
function FinalizeStartupCommand:Execute(): Result.Result<boolean>
	return Result.Catch(function()
		...
		return EntityOperationSupport.RequireLifecycleStates(self._validationService, "FinalizeStartup", currentState, {
			"RegisteringECS",
			"CompilingECS",
...
function FinalizeStartupCommand:_BeginECSCompile(): Result.Result<boolean>
...
function FinalizeStartupCommand:_FinalizeECSKernel(): Result.Result<boolean>
...
function FinalizeStartupCommand:_FinalizeRuntimeRegistrations(): Result.Result<boolean>
...
function FinalizeStartupCommand:_EnsureBuiltInOperationalProofRuntime(): Result.Result<boolean>
...
function FinalizeStartupCommand:_EnsureBuiltInOperationalProofActorType(): Result.Result<boolean>
...
function FinalizeStartupCommand:_HandleStartupFailure()
	local currentState = self._lifecycle:GetState()
