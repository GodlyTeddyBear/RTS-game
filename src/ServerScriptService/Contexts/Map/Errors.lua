...
return table.freeze({
	...
	MISSING_WORKSPACE_LOBBY_CONTAINER = "MapContext: Workspace.Map.Lobby container is missing",
	...
	LOBBY_SPAWN_NOT_FOUND = "MapContext: lobby spawn marker could not be resolved",
	RUN_ENTRY_NOT_FOUND = "MapContext: run entry marker could not be resolved",
})
