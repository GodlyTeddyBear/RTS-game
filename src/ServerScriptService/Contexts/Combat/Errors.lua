...
Errors.MISSING_ACTOR_RUNTIME_BINDING = "CombatContext: actor type semantic requirements are missing runtime binding metadata"
Errors.INVALID_ACTOR_RUNTIME_BINDING_OWNER = "CombatContext: actor type runtime binding owner is invalid"
Errors.ACTOR_POLL_REQUIREMENT_UNSATISFIED = "CombatContext: actor type polling requirement is not satisfied"
Errors.ACTOR_PROJECTION_REQUIREMENT_UNSATISFIED = "CombatContext: actor type projection requirement is not satisfied"
