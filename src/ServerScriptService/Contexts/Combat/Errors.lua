...
Errors.INVALID_COMBAT_ABILITY = "CombatContext: invalid combat ability"
Errors.DUPLICATE_COMBAT_ABILITY = "CombatContext: combat ability is already registered"
Errors.UNKNOWN_COMBAT_ABILITY = "CombatContext: combat ability is not registered"
