...
local FlowSeparationSolveOperation = ParallelRunner.DefineJob({
	...
	PayloadSchema = {
		...
		GoalGroupCellLookupStartIndex = { ParallelRunner.Arg.u32() },
		GoalGroupCellLookupCount = { ParallelRunner.Arg.u32() },
		...
		LookupPackedKey = { ParallelRunner.Arg.u32() },
		LookupCellRecordIndex = { ParallelRunner.Arg.u32() },
