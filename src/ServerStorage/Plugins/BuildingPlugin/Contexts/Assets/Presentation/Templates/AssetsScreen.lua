...
local function AssetsScreen()
	...
	return React.createElement(StudioComponents.ScrollFrame, {
		...
		LibraryBrowser = React.createElement(LibraryBrowserPanel, {
			...
			SelectedAssetPath = viewModel.SelectedLibraryAssetPath,
			OnDeleteSelectedAsset = assetsActions.DeleteSelectedLibraryAsset,
			OnInsertSelectedAsset = assetsActions.InsertSelectedLibraryAsset,
			OnSelectedAssetPathChanged = assetsActions.SetSelectedLibraryAssetPath,
