...
local Enums = {
	...
	MouseButton = EnumList.new("MouseServiceMouseButton", {
		"Left",
		"Right",
	}),
	GesturePhase = EnumList.new("MouseServiceGesturePhase", {
		"Pressed",
		"Released",
		"Clicked",
		"DoubleClicked",
	...
	ErrorKey = EnumList.new("MouseServiceErrorKey", {
		...
		"InvalidHoverRequest",
		"InvalidDragRequest",
		"InvalidGestureRequest",
		"InvalidDragMode",
		"InvalidEnabledButtons",
		"InvalidClickMaxMovement",
		"InvalidDoubleClickWindow",
		"InvalidDoubleClickMaxMovement",
		"InvalidHoldDuration",
		"InvalidDragStartThreshold",
		...
		"MissingGestureSession",
		"DuplicateGestureSession",
		"IllegalGestureTransition",
		"MissingDragSession",
...
Enums.ErrorMessage = table.freeze({
	...
	[Enums.ErrorKey.InvalidGestureRequest] = "MouseService gesture request is invalid",
	[Enums.ErrorKey.InvalidDragMode] = "MouseService DragMode must be a valid drag mode when provided",
	[Enums.ErrorKey.InvalidEnabledButtons] = "MouseService EnabledButtons must be an array of supported mouse buttons when provided",
	[Enums.ErrorKey.InvalidClickMaxMovement] = "MouseService ClickMaxMovement must be a non-negative number when provided",
	[Enums.ErrorKey.InvalidDoubleClickWindow] = "MouseService DoubleClickWindow must be a positive number when provided",
	[Enums.ErrorKey.InvalidDoubleClickMaxMovement] = "MouseService DoubleClickMaxMovement must be a non-negative number when provided",
	[Enums.ErrorKey.InvalidHoldDuration] = "MouseService HoldDuration must be a positive number when provided",
	[Enums.ErrorKey.InvalidDragStartThreshold] = "MouseService DragStartThreshold must be a non-negative number when provided",
	...
	[Enums.ErrorKey.MissingGestureSession] = "MouseService gesture session does not exist for this channel",
	[Enums.ErrorKey.DuplicateGestureSession] = "MouseService gesture session already exists for this channel",
	[Enums.ErrorKey.IllegalGestureTransition] = "MouseService gesture transition is not allowed",
