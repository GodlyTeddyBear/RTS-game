...
local zoomController =
	require(plr:WaitForChild("PlayerScripts"):WaitForChild("PlayerModule").CameraModule.ZoomController)
	...
	local specialFunctionsTable = {
		Start = { --this is an array so you can iterate in order
			...
			},
			{
				...
				function(useCurrentZoomDistance)
					...
					local cameraOffset =
						CFrame.new(0, zoomDistance / 2.6397830596715992, zoomDistance / 1.0352760971197642)
