...
--[=[
	@interface TBreweryScreenViewProps
	Props for the BreweryScreenView component.
	.containerRef {current: Frame?} -- Ref to the root container for transition animation
	.recipeCount number -- Total number of recipes to display in the count label
	.scrollChildren {[string]: any} -- Children to render inside the scrolling content area
	.onBack () -> () -- Callback fired when back button is activated
]=]
type TBreweryScreenViewProps = {
...
--[=[
	@class BreweryScreenView
	Presentational view for the brewery screen layout. Renders header, tab bar, recipe scroll area, and footer.
	@client
]=]
local function BreweryScreenView(props: TBreweryScreenViewProps)
	return e("Frame", {
