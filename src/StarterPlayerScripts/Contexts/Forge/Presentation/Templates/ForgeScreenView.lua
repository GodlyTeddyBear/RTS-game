...
--[=[
	@interface TForgeScreenViewProps
	Props for the forge screen presentational view.
	.containerRef { current: Frame? } -- Reference to container frame for transitions
	.recipeCount number -- Number of recipes to display in header
	.scrollChildren { [string]: any } -- Scrollable recipe list contents
	.onBack () -> () -- Callback for back button
]=]
type TForgeScreenViewProps = {
...
--[=[
	@class ForgeScreenView
	Presentational view for the forge screen; renders header, tabs, recipe scroll, and footer.
	@client
]=]
local function ForgeScreenView(props: TForgeScreenViewProps)
	-- Root container with header, tab bar, scrollable content, and footer
	return e("Frame", {
		...
		-- Main content area with scrollable recipe list
		Content = e(Frame, {
