...
export type TUpgradeScreenViewProps = {
...
--[=[
	@class UpgradeScreenView
	Presentational view for the upgrades screen layout. Renders header, count bar, scroll area, and footer.
	@client
]=]
local function UpgradeScreenView(props: TUpgradeScreenViewProps)
	return e("Frame", {
		...
		TabBar = e(Frame, {
			...
			children = {
				...
				Amount = e("TextLabel", {
					Text = tostring(props.upgradeCount),
